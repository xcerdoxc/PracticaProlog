...
paraula(P10),length(P10,N10),N10 is 5,not(repetits([P10,P3])),verificaP9P10(P9,P10),
paraula(P11),length(P11,N11),N11 is 6,verificaP8P11(P8,P11),
paraula(P12),length(P12,N12),N12 is 8,not(repetits([P12,P7,P8,P9])),verificaP8P12(P8,P12),
paraula(P13),length(P13,N13),N13 is 6,not(repetits([P13,P11])),verificaP12P13(P12,P13),
paraula(P14),length(P14,N14),N14 is 5, not(repetits([P14,P10,P3])),verificaP13P14(P13,P14).
